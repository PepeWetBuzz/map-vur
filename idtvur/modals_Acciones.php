...
<div class="modal fade" id="modal_informacion" tabindex="-1" role="dialog" aria-labelledby="modal_informacionLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal_informacionLabel">Acerca de este Geoportal Magellan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p class="text-justify">
              El Portal geoespacial Magellan (en homenaje al navegante y 
			  cart&oacute;grafo portugu&eacute;s, Don Fernando de Magallanes), 
              es una herramienta colaborativa de datos geoespaciales  
              construida con visión del territorio, para gestionar datos 
              e información a través de mapas; con la capacidad de integrar im&aacute;genes aéreas de 
              ...
              y externa de la información en la organizaci&oacute;n, de una manera rápida, ágil y segura.
            </p>
        
        <p class="text-justify">

        <small>Este portal fue desarrollado por Jos&eacute; Antonio Nava V&eacute;lez y el equipo 
		"Geozombis existencialistas del c&oacute;digo espagueti y la contracultura", con la colaboración 
		de Naum "Lomito" Garc&iacute;a Meza, Hugo Delgadillo, Jos&eacute; Luis Parra, XuxoTon P&eacute;rez 
		y Miguel Parra.</small>
